  ...
  <svg class="bezier-curve" width="150" height="250" @mousedown="$emit('drag-start', $event)">
    <g>
      ...
      <line
        ...
        :y2="beginPoints[3]"
      />
      <circle class="bezier-control-circle" :cx="beginPoints[2]" :cy="beginPoints[3]" r="7" />
      ...
      <line
        ...
        :y2="endPoints[3]"
      />
      <circle class="bezier-control-circle" :cx="endPoints[2]" :cy="endPoints[3]" r="7" />
    </g>
  </svg>
</template>
...
export default {
  name: 'BezierCurve',
  props: ['cubicBezierPathData', 'linearLinePoints', 'beginPoints', 'endPoints'],
};
</script>
